...
public class StudentList {
	 ...
	 * @return true is removed false if failed to remove
	 */
	...
	/**
	 * Used to print the list of Students Format: fname lname credit status
	 * tuition_due
	 */
	public void print() {
		for (int i = 0; i < numStudents; i++) {
	...
	/**
	 * stores all the outputs to one string to be printed out as output
	 * 
	 * @return the string with the output to be printed
	 */
	public String printAllStudents() {
		String allStudent = "";
		for (int i = 0; i < numStudents; i++) {
			allStudent = allStudent + list[i].toString() + ", Tuition Due: $" + list[i].tuitionDue() + "\n";
		}
		return allStudent;
	}
