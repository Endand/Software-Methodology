...
public class International extends Student {
	...
	/**
	 * Constructor takes a International Student object's fields to create a new
	 * International Student with same data
	 * 
	 * @param fname    First Name
	 * @param lname    Last Name
	 * @param credit   Number of Credit
	 * @param exchange whether or not the student is an exchange student
	 */
