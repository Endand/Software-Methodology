...
public abstract class Student implements Comparable {
	...
	/**
	 * Constructor takes a Student object's fields to create a new Student with same
	 * data
	 * 
	...
	/**
	 * Used to compare first name and last name to see if Student is equal must
	 * implement compareTo method because Student class implements the Comparable
	 * Interface
	 * 
	 * @param obj Student to be compared with
	 * @return 0 if first name and last name are equal, -1 if this is greater than
	 *         obj, 1 if this less than obj
	 */
	...
	/**
	 * Used to convert Student's fields into String subclasses will be using this
	 * method.
	 * 
	 ...
	 * subclasses.
	 * 
	 * @return tuition due for Student
	 */
