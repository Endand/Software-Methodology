...
public class Instate extends Student {
	...
	/**
	  * Constructor takes a Instate Student object's fields to create a new Instate Student with same data
	  * @param  fname, lname, credit, funds, whose fields will be used for new Instate Student
	  */
